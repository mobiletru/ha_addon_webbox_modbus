...
from .modbus_client import _decode, _merge_read_blocks, _word_count
...
def read_modbus_bundle_sync(webbox: dict[str, Any], kind: str | None = None) -> dict[str, Any]:
    try:
    ...
    try:
        ...
        profile_values = _read_profile_values(client, unit, rkw, names) if online else {}
...
async def read_modbus_bundle(webbox: dict[str, Any], kind: str | None = None) -> dict[str, Any]:
    return await asyncio.to_thread(read_modbus_bundle_sync, webbox, kind)
